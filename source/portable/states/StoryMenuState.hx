...
class StoryMenuState extends MusicBeatState
{
	...
	function updateChar()
	{
		...
		{
			var weekFormated = weekArray[i].replace("_hardcore", "");
			var char_diff = "";
			if (lastDifficultyName == "hardcore" && grpWeekCharacters.members[i].character != "")
				char_diff = "_hardcore";
			grpWeekCharacters.members[i].changeCharacter(weekFormated + char_diff);
		}
	}
